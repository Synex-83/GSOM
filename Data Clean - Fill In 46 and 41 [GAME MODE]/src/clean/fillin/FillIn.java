	...
	public void readFromFile(String fileName, String parent)
	{
		...
		try
		{
			...
			while((strLine = br.readLine()) != null)
			{
				if(strLine.contains("***************"))
				{
					remString = strLine.substring(17);
					COUNTER = 1;
				}
				else if(COUNTER == 1)
				{
					...
					if(strLine.contains("#####"))
					{
						...
						switch (junctionInt1) {
						case 42:
							LINES_TO_WRITE += "23 1 041 Down" + " "+ remString +"\r\n" + strLine + "\r\n";
							break;
							
						case 51:
							LINES_TO_WRITE += "23 1 041 Right" + " "+ remString + "\r\n" + strLine + "\r\n";
							break;
							
						case 36:
							LINES_TO_WRITE += "26 3 046 Right" + " "+ remString +"\r\n" + strLine + "\r\n";
							break;
						
						case 47:
							LINES_TO_WRITE += "26 3 046 Up" +" "+ remString + "\r\n" + strLine + "\r\n";
							break;
