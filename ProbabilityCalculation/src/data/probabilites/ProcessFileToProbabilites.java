...
/*	private int returnDecsionInt(String value)
	...
	private void writeToFile(String line, String parent)
	{
		...
		if(MODE==1){
			writeFileName = "NUMBER-TEST-1.txt";
		}else if(MODE==2){
			writeFileName = "NUMBER-TEST-2.txt";
		}else if(MODE==3){
			writeFileName = "NUMBER-TEST-3.txt";
		}else if(MODE==4){
			writeFileName = "NUMBER-TEST-4.txt";
		}
				
		try
		{
			bw = new BufferedWriter(new FileWriter(parent +"\\"+ writeFileName,false));
			bw.write(line);
			bw.newLine();
			bw.flush();
		}
	...
	public static void main(String[] args) throws FileNotFoundException 
	{
		...
		while(i < 4)
		{
			pft.readFromFile("output4.txt", "E:\\PhD\\My Data\\30.Dawpadee Kiriella [incomplete data]",i);
			i++;
		}
	}
